      ...
      <div class="h-100">
        ...
        <ul class="sidebar-nav nav nav-bills flex-column mt-4">
          <li class="sidebar-item">
            <a
              href="https://vue-project-tu-1.onrender.com/guest/homepage"
          ...
          <li class="sidebar-item">
            <a
              href="https://vue-project-tu-1.onrender.com/guest/GuestFaculies"
              class="sidebar-link d-flex text-decoration-none align-items-center text-white"
              style="width: 20px"
            >
              <img
...
//     logout() {
//       axios
//         .post("https://backend-final-zk84.onrender.com/v1/logout", {
