      ...
      <div class="h-100">
        ...
        <ul class="sidebar-nav nav nav-bills flex-column mt-4">
          <li class="sidebar-item">
            <a
              href="https://vue-project-tu-1.onrender.com/coordinator/homepage"
          ...
          <!-- <li class="sidebar-item">
            <a
              href="https://vue-project-tu-1.onrender.com/coordinator/createdeadline"
              class="sidebar-link d-flex text-decoration-none align-items-center text-white"
              style="width: 20px"
            >
              <img
          ...
          <li class="sidebar-item">
            <a
              href="https://vue-project-tu-1.onrender.com/coordinator/listcomment"
              class="sidebar-link d-flex text-decoration-none align-items-center text-white"
              style="width: 20px"
            >
              <img
          ...
          <li class="sidebar-item">
            <a
              href="https://vue-project-tu-1.onrender.com/Coordinator/charts"
              class="sidebar-link d-flex text-decoration-none align-items-center text-white"
              style="width: 20px"
            >
              <img
